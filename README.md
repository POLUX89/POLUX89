...
| 🚁 | **asrs-rotorcraft-nlp** | **MSc thesis** — taxonomic coverage of NASA ASRS incident narratives in rotorcraft operations. Domain expertise from 1500+ flight hours applied to model auditing and disaggregated evaluation | `Python` `NLP` `Transformers` | ![](https://img.shields.io/badge/thesis-8957e5?style=flat) | [Repo](https://github.com/POLUX89/asrs-rotorcraft-nlp) |

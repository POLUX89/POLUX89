...
|:--:|---|---|---|:--:|---|
| 🏋️ | **rehab-strength** | Three independent data sources → weekly snapshot with freshness badges; regression + classification explained with SHAP; **one-click synthetic demo**, so it opens with zero real health data | `Python` `Streamlit` `Pandas` | ![](https://img.shields.io/badge/live-2ea44f?style=flat) | **[Live app »](https://rehab-strength.streamlit.app)** · [Repo](https://github.com/POLUX89/rehab-strength) |
